                ...
                <div className="flex space-x-6">
                    <div className="bg-gray-300 p-4 rounded-md shadow-md w-full max-w-md">
                        ...
                        <div className="text-center">
                            ...
                            <a href="/client/procurarPresencas" className="block text-gray-600 font-bold hover:text-gray-400 py-2">Procurar Presença</a>
                        </div>
                    </div>
                    <div className="bg-gray-300 p-4 rounded-md shadow-md w-full max-w-md">
                    ...
                    <div className="bg-gray-300 p-4 rounded-md shadow-md w-full max-w-md">
                        <h1 className="text-gray-900 text-lg font-bold text-center pb-3">FitManager | Área do Administrador</h1>
                        <div className="text-center">
